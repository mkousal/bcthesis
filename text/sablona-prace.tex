...
\usepackage{siunitx} % Balíček pro jednotky SI
\sisetup{output-decimal-marker = {,}}

\usepackage{url}  % Balíček potřebný pro použití české citace
% \DeclareUrlCommand\url{\def\UrlLeft{<}\def\UrlRight{>} \urlstyle{tt}}
\usepackage[strings]{underscore}

\usepackage{multirow} % balíček pro spojování položek v tabulce

\usepackage{subfig} % balíček pro více obrázků v jednom
...
%	language={Matlab},		% Matlab
	language={C},           % jazyk C
    basicstyle=\small\ttfamily,	% definice základního stylu písma
