...
\includepdf[pages=1]{obrazky/iotAirMonitoring.pdf}
\includepdf[pages=2]{obrazky/iotAirMonitoring.pdf}
\includepdf[pages=3]{obrazky/iotAirMonitoring.pdf}

\chapter{Foto realizované desky plošných spojů}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{obrazky/pcb-blank.jpg}
	\caption{Foto realizované desky osazené z výroby.}
	\label{fig_PCB-blank}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{obrazky/pcb-full.jpg}
	\caption{Foto realizované desky včetně doosazení součástek a přidání modulů se senzory.}
	\label{fig_PCB-full}
\end{figure}