...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{obrazky/ldo-schematic.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{obrazky/ldo18-schematic.pdf}
...
\subsection{Návrh nabíjecího obvodu}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{obrazky/datasheetSchematicLT3652.png}
