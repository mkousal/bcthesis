...
\begin{figure}[h]
    \centering
    \subfloat[][3D model desky plošného spoje]{\includegraphics[width=0.41\textwidth]{obrazky/batteryCharger-top_.png}}
    \subfloat[][Vyrobená a osazená deska plošného spoje]{\includegraphics[width=0.59\textwidth]{obrazky/batteryCharger-final.png}}
