...
%%% Abstrakt
\abstract[%
Purpose of this semestral work is to make a device that can measure air quality parameters and send them wirelessly to the server, where that measured data are processed and then showed to the user. The aim is to create a device with the lowest possible power consumption for the possibility of the battery operation.
]{%
